...
import google_drive_util from "../../../../../../common/integrations/GoogleDrive.js";
import { removeTokens } from "../../../blockly-worksace.js";
...
const AccountDropdown = React.forwardRef((props, dropdownRef) => {
  ...
  const { is_bot_running, show_bot_unavailable_page } = useSelector(
    (state) => state.ui
  );
  ...
  return (
    <div className="account__switcher-dropdown-wrapper show" ref={dropdownRef}>
      <div
        ...
        className="account__switcher-dropdown"
        ref={container_ref}
      >
        <div className="account__switcher-container">
          <ul className="account__switcher-tabs">
            <li
              className={`account__switcher-tab ${
                activeTab === "real" ? "ui-tabs-active" : ""
              }`}
        ...
        <div className="account__switcher-total">
          <div className="account__switcher-total-balance">
            <span className="account__switcher-total-balance-text">
            ...
            <span className="account__switcher-total-balance-amount account__switcher-balance">
              ...
              <span className="symbols">
                &nbsp;{activeTab === "demo" ? "USD" : total_deriv.currency}
              </span>
            </span>
          </div>
          <Separator />
