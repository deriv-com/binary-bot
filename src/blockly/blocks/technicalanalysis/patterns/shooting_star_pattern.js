...
Blockly.JavaScript.shooting_star_pattern = block => [`Bot.isShootingStarPattern({ granularity: ${getGranularity(block)}, index: ${Blockly.JavaScript.valueToCode(block, 'INDEX', Blockly.JavaScript.ORDER_ATOMIC) || '1'} })`, Blockly.JavaScript.ORDER_ATOMIC];
