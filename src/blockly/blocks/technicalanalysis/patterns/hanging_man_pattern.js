...
Blockly.JavaScript.hanging_man_pattern = block => [`Bot.isHangingManPattern({ granularity: ${getGranularity(block)}, index: ${Blockly.JavaScript.valueToCode(block, 'INDEX', Blockly.JavaScript.ORDER_ATOMIC) || '1'} })`, Blockly.JavaScript.ORDER_ATOMIC];
