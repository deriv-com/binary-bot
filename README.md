...
## Hide Deriv/Binary Branding (Logos and Deriv/Binary Mentions)

To hide mentions of Deriv/Binary and Deriv branding related links and actions add a enviornment variable (i.e. .env) `HIDE_OFFICIAL_BRANDING`

Following Items will disappear from UI:

1.  App Switcher
2.  Link to Deriv Reports
3.  Link to Deriv Cashier
4.  Link to Deriv help-center
5.  Binary Trading view dialog and button from toolbar
6.  Mention of Deriv from account menu
7.  Add Deriv account link
